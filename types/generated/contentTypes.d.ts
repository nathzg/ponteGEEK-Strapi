...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    keywords: Schema.Attribute.Component<'shared.array', true>;
    keywords_array: Schema.Attribute.JSON;
    ...
    tags: Schema.Attribute.Component<'shared.array', true>;
    tags_array: Schema.Attribute.JSON;
    thumbnail: Schema.Attribute.Media<'images'>;
    thumbnailText: Schema.Attribute.String;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.Component<'shared.array', true>;
    skills_array: Schema.Attribute.JSON;
    slug: Schema.Attribute.UID<'name'>;
    social: Schema.Attribute.Component<'shared.array', true>;
    social_array: Schema.Attribute.JSON;
    thumbnail: Schema.Attribute.Media<'images'>;
...
export interface ApiSocialPostSocialPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    publishedPost: Schema.Attribute.DateTime & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.String & Schema.Attribute.Unique;
    tag: Schema.Attribute.Relation<'manyToMany', 'api::content.content'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
